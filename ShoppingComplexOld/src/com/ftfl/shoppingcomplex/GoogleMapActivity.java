...
import com.ftfl.shoppingcomplex.util.JSONParser;
...
public class GoogleMapActivity extends FragmentActivity implements LocationListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (mID != null) {
			...
			mAddress = mUpdateShoppingComplex.getAddress();
			 mLatitude = mUpdateShoppingComplex.getLatitude();
			 mLongitude = mUpdateShoppingComplex.getLongitude();
	...
	public void onLocationChanged(Location location) {
		...
		// create marker
		MarkerOptions marker = new MarkerOptions().position(latLng).title("Dhaka ");
		 
		// adding marker
		googleMap.addMarker(marker);
		
		MarkerOptions marker2 = new MarkerOptions().position(new LatLng(dLatitude, dLongitude)).title(mAddress);
