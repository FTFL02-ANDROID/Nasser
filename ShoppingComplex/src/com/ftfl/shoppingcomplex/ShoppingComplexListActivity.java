...
public class ShoppingComplexListActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ArrayAdapter<String> mShoppingComplexAdapter = new ArrayAdapter<String>(this,
	...
	private void setListData() {
		ShoppingComplexDataSource shoppingComplexData = new ShoppingComplexDataSource(this);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case R.id.addShoppingComplex:
        	startActivity(new Intent(ShoppingComplexListActivity.this, AddShoppingComplexActivity.class));
            return true;
