...
public class DailyProfileViewOneAdapter extends ArrayAdapter<ICareActivityChart>{
	...
	public DailyProfileViewOneAdapter(Activity context, List<ICareActivityChart> allDailyDietChart) {
